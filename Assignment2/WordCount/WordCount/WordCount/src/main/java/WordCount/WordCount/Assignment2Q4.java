...
import WordCount.WordCount.Assignment2Q3.IntSumCombainer;
import WordCount.WordCount.Assignment2Q3.IntSumReducer;
import WordCount.WordCount.Assignment2Q3.TokenizerMapper;
	 ...
	 public static class TokenizerMapper
	    ...
	    extends Reducer<Text,DoubleWritable,Text,DoubleWritable> {
		 ...
		 public static void main(String[] args) throws Exception {
			    ...
			    Job job = Job.getInstance(conf, "Assignment 2 Q4");
